    ...
    <>
       <div class="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
        <div class="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
          <div>
          <h2 class="flex items-center justify-center leading-6 text-sky-600 font-semibold tracking-wide uppercase">Transactions</h2>
            <div class="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
               <p class="mt-2 my-8 text-3xl leading-8 font-extrabold tracking-tight text-center text-gray-900 sm:text-4xl">A better way to send money</p>
            </div>
          </div>
          <div class="relative">
      ...
      <div class="bg-white">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8">
            <h2 class="max-w-md mx-auto text-3xl font-extrabold text-center lg:max-w-xl lg:text-left text-transparent bg-clip-text bg-gradient-to-br from-blue-500 to-green-600">The world's most innovative companies use Workflow</h2>
