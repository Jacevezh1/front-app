    ...
    <>
      ...
      <div class="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
        <div class="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
          <div>
            <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Glosario</h2>
            <div class="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
              <p class="text-xl text-gray-500">Aprende el vocabulario del ecosistema cripto...</p>
            </div>
          </div>
                  ...
                  <div>
                    ...
                    <div class="mt-3">
                      <Link to={`/concepts/${element._id}`} class="mt-2 block">
                        <p class="text-base font-semibold text-sky-600 hover:text-cyan-500"> Continuar lectura...  </p>
                      </Link>
                    </div>
                  </div>
                </>
